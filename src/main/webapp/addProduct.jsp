		...
		<div class="row">
			<div class="col">
				<form action="./processAddProduct.jsp" name="newProduct"
					method="POST" enctype="multipart/form-data" class="p-5 m-3">

					<div class="mb-3">
						<label for="productId" class="form-label"><fmt:message
								key="productId" /></label> <input type="text" class="form-control"
							id="productId" name="productId">
						<div class="form-text">상품의 코드를 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="productName" class="form-label"><fmt:message
								key="pname" /></label> <input type="text" class="form-control"
							id="productName" name="productName">
						<div class="form-text">상품명을 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="unitPrice" class="form-label"><fmt:message
								key="unitPrice" /></label> <input type="text" class="form-control"
					...
					<div class="mb-3">
						...
						<textarea cols="50" rows="5" class="form-control" id="description"
							name="description"></textarea>
						<div class="form-text">상품에 대한 상세정보를 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="manufacturer" class="form-label"><fmt:message
								key="manufacturer" /></label> <input type="text" class="form-control"
							id="manufacturer" name="manufacturer">
						<div class="form-text">상품의 제조사를 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="category" class="form-label"><fmt:message
								key="category" /></label> <input type="text" class="form-control"
							id="category" name="category">
						<div class="form-text">상품의 분류를 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="unitsInStock" class="form-label"><fmt:message
								key="unitsInStock" /></label> <input type="text" class="form-control"
							id="unitsInStock" name="unitsInStock">
						<div class="form-text">상품의 재고수량을 입력해주세요.</div>
					</div>

					<div class="mb-3">
						<label for="condition class="form-label"><fmt:message
								key="condition" /></label>
						...
						<br>
						<div class="mb-3">
							<label for="imageUpload" class="form-label"><fmt:message
									key="imageUpload" /></label> <input type="file" class="form-control"
								id="img" name="imageUpload">
							<div class="form-text">
								<fmt:message key="productImage" />
							</div>
						</div>
					</div>
					...
					<button type="button" onclick="checkAddProduct()"
