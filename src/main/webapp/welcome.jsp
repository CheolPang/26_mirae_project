				...
				<div class="row justify-content-between">
					<div class="col-lg-5">
						<div class="intro-excerpt">
							<h1>
								<fmt:message key="wtitle-1" />
								<br>
								<fmt:message key="wtitle-2" />
							</h1>
							<p class="mb-4">
								<fmt:message key="wtitle-se" />
							</p>
							<p>
								<a href="products.jsp" class="btn btn-white-outline me-2"
									role="button"><fmt:message key="product-list" /></a><a href="#"
									class="btn btn-white-outline"><fmt:message key="report" /></a>
							</p>
						</div>
					</div>
					<div class="col-lg-7">
				...
				<div class="row">
					...
					<div class="col-md-12 col-lg-3 mb-5 mb-lg-0">
						<h2 class="mb-4 section-title">
							<fmt:message key="popular-list" />
						</h2>
						<p class="mb-4">
							<fmt:message key="popular-se" />
						</p>
						<p>
							<a href="products.jsp" class="btn" role="button"><fmt:message
									key="deabogi" /></a>
						</p>
					</div>
					<!-- End Column 1 -->
				...
				<div class="row justify-content-between">
					<div class="col-lg-6">
						<h2 class="section-title">
							<fmt:message key="whychoose-t" />
						</h2>
						<p>
							<fmt:message key="whychoose-s" />
						</p>
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>
										<fmt:message key="fast-shipping" />
									</h3>
									<p>
										<fmt:message key="fast-shipping-se" />
									</p>
								</div>
							</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>
										<fmt:message key="easy-buy" />
									</h3>
									<p>
										<fmt:message key="easy-buy-se" />
									</p>
								</div>
							</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>
										<fmt:message key="24-report" />
									</h3>
									<p>
										<fmt:message key="24-report-se" />
										.
									</p>
								</div>
							</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									...
									<h3>
										<fmt:message key="free-banpum" />
									</h3>
									<p>
										<fmt:message key="free-banpum-se" />
									</p>
								</div>
							</div>
												...
												<div class="author-info">
													<div class="author-pic">
														<svg xmlns="http://www.w3.org/2000/svg" height="80px"
															viewBox="0 -960 960 960" width="80px" fill="#e3e3e3">
															<path
